...
import ParticpantSelector from "./participant-selector";
...
export const ExpenseForm = ({ type, onSuccess }) => {
  ...
  const onSubmit = async (data) => {
    try {
        ...
        const groupId = type === "individual" || !rawGroupId ? undefined : rawGroupId;
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              id="description"
              placeholder="Lunch, Movie Ticket, etc."
        ...
        <div className="space-y-2">
          ...
          >
            <option value="">See who paid</option>
        ...
        <div className="space-y-2">
          ...
          <Tabs 
            defaultValue="equal" className="pb-3"
          ...
          >
            ...
            <TabsContent value="equal" className="pt-4">
                <p className="text-sm text-muted-foreground">
                    Split equally among all participant
                </p>
                <SplitSelector 
                    type="equal"
