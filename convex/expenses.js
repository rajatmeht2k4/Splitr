...
export const createExpense = mutation({
    ...
    handler: async(ctx, args) => {
        ...
        // Verify that splits add up to the total amount (with small tolerance for floating point issue)
...
export const getExpenseBetweenUsers = query({
    ...
    handler: async (ctx, {userId}) => {
        ...
        // ------------ 1. One-on-One expenses where either user is the prayer ------------
        ...
        // ------------ 2. Keeps only rows where BOTH are involved (payer or split) ------------
        const expenses = candidateExpenses.filter((e) => {
            
            // me is always involved (I'm the payer Or in splits - verfied below)
        ...
        for ( const s of settlements ) {
            ...
            else balance -= s.amount; // They pay me back
        }
...
export const deleteExpense = mutation({
    ...
    handler: async(ctx, args) => {
        ...
        // Only the creator of the expense or the payer cna delete it 
